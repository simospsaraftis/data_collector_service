...
Δημιουργούμε έναν κατάλογο με όνομα files μέσα στον κατάλλογο /var/log-in/ και μέσα σε αυτόν τον κατάλλογο δημιουργούμε ένα αρχείο με όνομα file_1 μέσω των ακόλουθων εντολών:
