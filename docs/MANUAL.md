...
Εκτελώντας την ακόλουθη εντολή, μπορούμε να δούμε το περιεχόμενο του collection logs:
...
Στη συνέχεια, δημιουργούμε έναν κατάλογο με όνομα files μέσα στον κατάλογο /var/log-in/ και μέσα σε αυτόν τον κατάλογο δημιουργούμε ένα αρχείο με όνομα file_1, μέσω των ακόλουθων εντολών:
...
Μετά από λίγο, ελέγχουμε το περιεχόμενο της βάσης και παρατηρούμε ότι υπάρχει η ακόλουθη εγγραφή:
