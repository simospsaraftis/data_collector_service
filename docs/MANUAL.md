...
### 2.4 Σύνδεση των κόμβων του σμήνους με το δίκτυο της βάσης δεδομένων

Για λόγους καλύτερης διαχείρισης, έχουμε ορίσει το container που περιέχει τη βάση δεδομένων, να βρίσκεται σε διαφορετικό δίκτυο από τους κόμβους του σμήνους.
Επομένως, για να μπορεί ο master να επικοινωνεί με τη βάση δεδομένων και να αποθηκεύονται τα συμβάντα που συλλέγονται μέσω του fluentd σε αυτή, θα πρέπει ο master να βρίσκεται στο ίδιο δίκτυο με τη βάση δεδομένων. 
