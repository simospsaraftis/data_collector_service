...
Προσπαθούμε, όσο είναι δυνατόν, να τηρούμε τον κανόνα που αναφέρει ότι καλό είναι να διαχωρίζουμε τους τομείς χρησιμοποιώντας μία υπηρεσία ανά container. Ωστόσο, δεν το πετυχαίνουμε πάντα.
...
Αρχικά, ενεργοποιούμε τον server, εκτελώντας την ακόλουθη εντολή στο τερματικό του master:
...
Στη συνέχεια, συνδεόμαστε στους workers, μεταβαίνουμε στον κατάλογο client_file και ενεργοποιούμε τους clients, εκτελώντας την ακόλουθη εντολή στα τερματικά των workers:
...
Έπειτα, συνδεόμαστε με τη βάση δεδομένων

Έπειτα, δημιουργούμε έναν κατάλογο με όνομα files μέσα στον κατάλλογο /var/log-in/ και μέσα σε αυτόν τον κατάλλογο δημιουργούμε ένα αρχείο με όνομα file_1, μέσω των ακόλουθων εντολών:

```
mkdir /var/log-in/files
touch /var/log-in/file_1
```

Οποιαδήποτε αλλαγή πραγματοποιούμε σε αυτό το αρχείο, θα στέλνεται ως συμβάν στη βάση και στη συνέχεια μέσω του ChangeStream θα λαμβάνεται και θα εμφανίζεται στο τερματικό από τον master/server και στη συνέχεια θα αποστέλλεται στους workers εκείνους οι οποίοι είναι clients, δηλαδή έχουν εγκαθιδρύσει σύνδεση με τον server. Οι clients θα εμφανίζουν τα συμβάντα αυτά στο τερματικό τους.