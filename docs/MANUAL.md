...
Επομένως, για να μπορεί ο master να επικοινωνεί με τη βάση δεδομένων και να αποθηκεύονται τα συμβάντα που συλλέγονται μέσω του fluentd σε αυτή, θα πρέπει να είναι συνδεδεμένος και με το δίκτυο της βάσης δεδομένων.<br/>
Για να το πραγματοποιήσουμε αυτό, θα χρησιμοποιήσουμε το interface του [swarmlab.io](http://docs.swarmlab.io/).<br/>
Πιο συγκεκριμένα, στο [swarmlab.io](http://docs.swarmlab.io/), μεταβαίνουμε στην καρτέλα Instances -> Container και επιλέγουμε το container hybrid_linux_master_1, το οποίο αντιστοιχεί στον master του σμήνους. Στη συνέχεια, επιλέγουμε το δίκτυο storage-mongo-replica_netSwarmlabMongo, το οποίο αποτελεί το δίκτυο στο οποίο βρίσκεται η βάση δεδομένων, και πατάμε το κουμπί "Update", όπως φαίνεται στην παρακάτω εικόνα:
...
### 2.5 Εγκατάσταση των υπηρεσιών στα containers του σμήνους
