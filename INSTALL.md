...
Στη συνέχεια, εγκαθιστούμε τα απαραίτητα προγράμματα και ρυθμίσεις που θα πρέπει να περιέχει το καθε container, ούτως ώστε να εκτελούνται οι λειτουργίες της εφαρμογής.<br/><br/>
...
Σε αυτή τη παράγραφο, δείχνουμε πως μπορούμε να δημιουργήσουμε το σμήνος, το οποίο θα αποτελείται από έναν κεντρικό κόμβο, τον master, και έναν ή περισσότερους κόμβους με τους οποίους θα συνδέεται ο master, τους workers.
