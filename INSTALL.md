...
Για την υλοποίηση και εγκατάσταση της εφαρμογής, θα αξιοποιηθεί το υπάρχον εικονικό εργαστήριο [hybrid-linux](https://git.swarmlab.io:3000/swarmlab/hybrid-linux), που παρέχεται από το περιβάλλον [swarmlab.io](http://docs.swarmlab.io/).
