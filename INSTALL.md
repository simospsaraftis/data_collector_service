...
Σε αυτή τη παράγραφο, θα δείξουμε πως μπορούμε να δημιουργήσουμε το σμήνος, το οποίο θα αποτελείται από έναν κεντρικό κόμβο, τον master, και έναν ή περισσότερους κόμβους με τους οποίους θα συνδέεται ο master, τους workers.
...
```
<br/><br/>
Για την εγκατάσταση και εκτέλεση του [ansible](https://www.ansible.com/), το οποίο θα εγκαταστήσει την υπηρεσία [node.js](https://nodejs.org/en/) σε όλους τους κόμβους του σμήνους, έχουμε δημιουργήσει το ακόλουθο bash αρχείο με όνομα nodejs.yml.sh:
<br/><br/>
```
#!/bin/sh
