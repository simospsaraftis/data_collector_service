...
sudo cp ../fluentd/files/ansible.cfg /etc/ansible/ansible.cfg
...
ansible-playbook -u docker -i /data_collector_service/fluentd/inventory.yml nodejs.yml  -f 5  --ask-pass --ask-become-pass
