...
- διαθέτει μηχανισμό σύνδεσης του κεντρικού κόμβου (master) με τους υπόλοιπους κόμβους (workers), για μεταφορά των δεδομένων/συμβάντων σε αυτούς σε πραγματικό χρόνο<br/><br/>
